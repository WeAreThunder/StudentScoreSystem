...
public interface StudentMapper {
    ...
    @Insert("insert into student(s_number,s_name,sex,birthday,class_name,phone,address) values (#{sNumber},#{sName},#{sex},#{birthday},#{className},#{phone},#{address})")
    public void create(@PathVariable("student") Student student);

    @Update("update student set s_number=#{sNumber},s_name=#{sName},sex=#{sex},birthday=#{birthday},class_name=#{className},phone=#{phone},address=#{address} where s_number=#{sNumber}")
